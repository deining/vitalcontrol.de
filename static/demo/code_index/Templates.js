...
,_className:"Templates::PushButton"};C.Jk={_Init:function(aArg){A.Core.P._Init.call(
this,aArg);this.__proto__=C.Jk;},_className:"Templates::TextEditor"};C.Menu={_Init:
...
C._Init=function(){C.AhC.__proto__=A.Core.P;C.Jk.__proto__=A.Core.P;C.Menu.__proto__=
A.Core.P;C.AhA.__proto__=A.Core.P;};C._ReInit=function(){};C.DJ=function(D){};return C;
})();
