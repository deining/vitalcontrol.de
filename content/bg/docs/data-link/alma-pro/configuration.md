...
Препоръчваме използването на версия на фърмуера <span style="font-weight: bold">25-04-Vxx</span> или по-висока с устройството VitalControl.\
