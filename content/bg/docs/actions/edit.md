...
6. За данните `{{<T "_ID" >}}` и `{{<T "DateBirth" >}}` ги изберете със стрелките △ ▽ и потвърдете с `{{<T "Ok" >}}`. Използвайте стрелките △ ▽, за да изберете съответното число и стрелките ◁ ▷ за навигация във полетата с числа.
