...
1. Sada će se pojaviti ekran za sinhronizaciju. Kliknite na dugme <img src="/digits/3_negative_circled.svg" width="25" align="middle" alt="circled number 3" title="number 3" /> `{{<T "Synchronize" >}}` u sredini na dnu da biste započeli sinhronizaciju s uređajem VitalControl.
    ...
    <figure class="figure" style="margin-top: 10px;">
        ...
        <figcaption class="figure-caption fs-6">Slika 3: Sinhronizacija VitalControl s automatskim feederom Alma Pro</figcaption>
    </figure>
