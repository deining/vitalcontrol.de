---
title: CSV-Datei für Massenmeldung bei AMA erzeugen
linkTitle: Erzeugung CSV-Datei
date: 2025-02-22T13:07:29+01:00
draft: false
weight: 30
url: fresser/at/erzeugung-csv
type: docs
slug: erzeugung-csv
description: >
...
---
  ...
  1. Wählen Sie mit den Pfeiltasten ◁ ▷ △ ▽ den Menüpunkt <img src="/icons/main/new-on-farm.svg" width="40" align="bottom" alt="Zukäufe" /> `Zukäufe` aus und bestätigen Sie mit `OK`.

  1. Es öffnet sich eine Liste mit Ihren Zukäufen, die Sie im vorherigen Schritt [`Abruf Tiere von Alma Pro`](../abruf/tiere) auf das VitalControl-Gerät überspielt haben.
      ...
      <figure class="figure" style="margin-top: 20px">
        ...
        <a name="AufrufZukaeufe" ><figcaption class="figure-caption fs-6">Abbildung 1: Aufruf des Listenbildschirms <span style="font-style: italic;">Zukäufe</span></figcaption></a>
      </figure>
  ...
  1. Drücken Sie mittlere obere `F2` Taste `CSV-Export`, um den Datenexport zu starten. Es öffnet sich nun ein Popup-Fenster, in dem Sie aufgefordert werden, einen USB-Stick in Ihr VitalControl-Gerät einzustecken.
      ...
      <figure class="figure" style="margin-top: 20px">
          ...
          <a name="AufrufExportZukaeufe" ><figcaption class="figure-caption fs-6">Abbildung 2: Aufruf des CSV-Exportvorgangs</figcaption></a>
      </figure>
  ...
  1. Stecken Sie den USB-Stick (C-Stecker) in die Buchse im Handgriff des Geräts ein.
      ...
      <figure class="figure">
          ...
          <a name="AnschlussBarcodescanner" ><figcaption class="figure-caption fs-6">Abbildung 3: USB-Stick am VitalControl einstecken</figcaption></a>
      </figure>
  ...
  1. Nach dem erfolgreichem Abschluss des Exports ist auf dem USB-Stick im Verzeichnis `zugaenge` <img src="/digits/1_negative_circled.svg" width="25" align="middle" alt="Circled digit 1" title="Ziffer 1" /> eine Datei mit dem Namen `zugang-TT-MM-JJJJ_HH-MM.csv` <img src="/digits/2_negative_circled.svg" width="25" align="middle" alt="Circled digit 2" title="Ziffer 2" /> hinterlegt. Diese CSV-Datei wird im nächsten Schritt zur [Massenmeldung](../zugang) bei AMA genutzt.
      ...
      <figure class="figure" style="margin-top: 20px">
          ...
          <a name="ExportZukaeufe" ><figcaption class="figure-caption fs-6">Abbildung 5: CSV-Exportdatei auf USB-Stick</figcaption></a>
      </figure>
  ...
  <div class="row">
    <div class="col">
      <div class="d-grid gap-2">
        <a class="text-start btn btn-lg btn-outline-primary" role="button"  href="../abruf/tiere/"><span class="fs-6">Vorherige</span><br><span class="fs-4 fw-semibold">« Abruf Tiere von Alma Pro</span></a>
      </div>
    </div>
    <div class="col">
      <div class="d-grid gap-2">
        <a class="text-end btn btn-lg btn-outline-primary " role="button" href="../zugang/"><span class="fs-6">Nächste Seite</span><br><span class="fs-4 fw-semibold">Massenmeldung AMA »</span></a>
      </div>
    </div>
  </div>
</div>
