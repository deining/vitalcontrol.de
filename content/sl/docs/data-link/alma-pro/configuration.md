...
<figure class="figure" style="margin-top: 5px;">
    <img src="../images/open-settings-vitalcontrol.png" usemap="#NavigationToVitalControlSettingsMenu" class="border border-2 figure-img img-fluid rounded p-3" align="bottom" alt="Nastavitve VitalControl: Dostop" title="Dostop do menija nastavitev VitalControl" />
...
<figure class="figure" style="margin-top: 5px;">
    <img src="../images/settings-vitalcontrol-1.png" usemap="#VitalControlSettingsPage1" class="border border-2 figure-img img-fluid rounded p-3" align="bottom" alt="Meni nastavitev VitalControl: Stran 1" title="Nastavitve VitalControl (1)" />
    <figcaption class="figure-caption fs-6">Posnetek zaslona 2: <span style="font-style: italic;">{{<T "VitalControl" >}}</span> meni nastavitev, Stran 1</figcaption>
</figure>
...
<figure class="figure" style="margin-top: 5px;">
    <img src="../images/settings-vitalcontrol-2.png" usemap="#VitalControlSettingsPage2" class="border border-2 figure-img img-fluid rounded p-3" align="bottom" alt="Meni nastavitev VitalControl: Stran 2" title="Nastavitve VitalControl (2)" />
...
<map name="VitalControlSettingsPage1">
    ...
    <area shape="rect" coords="142,517,215,616" alt='Stran 2' title='Kliknite Stran 2' href="#VitalControlSettingsPage1_Digit_8">
</map>
...
<map name="VitalControlSettingsPage2">
    ...
    <area shape="rect" coords="52,510,125,615" alt='Stran 1' title='Kliknite Stran 1' href="#VitalControlSettingsPage2_Digit_8">
</map>
