...
6. Za podatke `{{<T "_ID" >}}` in `{{<T "DateBirth" >}}` jih izberite s puščičnimi tipkami △ ▽ in potrdite z `{{<T "Ok" >}}`. Uporabite puščične tipke △ ▽ za izbiro ustrezne številke in puščične tipke ◁ ▷ za navigacijo znotraj številskih polj.
