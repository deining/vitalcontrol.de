...
{{% alert title="Savjet" %}}
Ako ova akcija nije dostupna, vjerojatno je deaktivirana! Aktivirajte akciju u izborniku [postavke akcija](../settings/). Alternativno, resetiranje svih akcija će ponovno omogućiti tu akciju.
{{% /alert %}}
