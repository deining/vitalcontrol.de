...
Συνιστούμε τη χρήση μιας έκδοσης firmware <span style="font-weight: bold">25-04-Vxx</span> ή νεότερης με τη συσκευή VitalControl.\
...
<div class="alert alert-primary d-flex align-items-center" role="alert">
    ...
    <div>
        ...
        Εάν η έκδοση firmware του τροφοδότη σας είναι χαμηλότερη από <span style="font-weight: bold">25-04-Vxx</span>, ενδέχεται να υπάρχουν διαφορές μεταξύ των παρακάτω στιγμιότυπων και της εμφάνισης στην οθόνη αφής σας, ώστε να μην μπορείτε να ακολουθήσετε τις οδηγίες. Σε αυτή την περίπτωση, επικοινωνήστε με τον τεχνικό σας για να ενημερώσετε το firmware στον τροφοδότη σας.<br>
    </div>
</div>
