...
6. En anden indstillingsmenu åbnes, hvor du kan gemme forskellige detaljer om den nye kalv. Brug piletasterne △ ▽ til at vælge den passende indstillingsmulighed. For indstillingsmulighederne `{{<T "TypeAnimal" >}}`, `{{<T "Sex" >}}`, `{{<T "BirthWeight" >}}`, `{{<T "Breed" >}}`, `{{<T "Whereabouts" >}}`, `{{<T "Multiples" >}}` og `{{<T "CalvingEase" >}}` brug piletasterne △ ▽ til at vælge den ønskede indstilling. For indstillingsmulighederne `{{<T "NationalAnimalID" >}}`, `{{<T "_ID" >}}` og `{{<T "DateBirth" >}}` vælg den tilsvarende indstillingsmulighed og bekræft med `{{<T "Ok" >}}`. Brug nu piletasterne △ ▽ ◁ ▷ til at vælge de ønskede tal.
