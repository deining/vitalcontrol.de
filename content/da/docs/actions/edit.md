...
6. For dataene `{{<T "_ID" >}}` og `{{<T "DateBirth" >}}` vælg dem med piletasterne △ ▽ og bekræft med `{{<T "Ok" >}}`. Brug piletasterne △ ▽ til at vælge det tilsvarende nummer og piletasterne ◁ ▷ til at navigere inden for nummerfelterne.
