...
1. Synkroniseringsskærmen vil nu blive vist. Klik på knappen <img src="/digits/3_negative_circled.svg" width="25" align="middle" alt="circled number 3" title="number 3" /> `{{<T "Synchronize" >}}` i midten nederst for at starte synkronisering med VitalControl-enheden.
    ...
    <figure class="figure" style="margin-top: 10px;">
        ...
        <figcaption class="figure-caption fs-6">Figur 3: Synkronisering af VitalControl med Alma Pro automatisk feeder</figcaption>
    </figure>
