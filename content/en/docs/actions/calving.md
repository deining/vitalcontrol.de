...
> [!Note] Hint
> If this action is not available for a cow, it has probably been deactivated!
> Activate the action in the [actions settings menu](/en/docs/actions/settings/). Alternatively, resetting all actions will also bring this action back.
