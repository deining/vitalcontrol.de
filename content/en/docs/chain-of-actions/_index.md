...
1. On the main screen of your VitalControl device, select the menu item &nbsp;<img src="/icons/action-chain.svg" width="40" align="bottom" alt="Chain of actions" />&nbsp; `Chain of actions` and press the `OK` button.
