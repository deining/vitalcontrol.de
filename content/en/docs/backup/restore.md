...
1. Open the menu item <img src="/icons/device.svg" width="40" align="bottom" alt="Device" /> `Device` in the main screen of the VitalControl device to which you want to restore the data.
