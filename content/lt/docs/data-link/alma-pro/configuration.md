...
<figure class="figure" style="margin-top: 5px; border: 2px solid #dee2e6; border-radius: 16px; overflow: hidden; margin-bottom: 0;">
    <div style="padding: 12px;">
       <img
        ...
        alt="VitalControl nustatymai: Prieiga"
        usemap="#NavigationToVitalControlSettingsMenu"
        style="max-width: 880px; width: 100%;"
        class="maphilight figure-img img-fluid" 
        align="bottom"
        title="Prieiga prie VitalControl nustatymų meniu" />
    </div>
...
<figcaption class="figure-caption fs-6" style="margin-bottom: 1.5rem;">
    Ekrano nuotrauka 2: Prieiga prie <span style="font-style: italic;">{{<T "VitalControl" >}}</span> nustatymų meniu
</figcaption>
...
<figure class="figure" style="margin-top: 5px; border: 2px solid #dee2e6; border-radius: 16px; overflow: hidden; margin-bottom: 0;">
    <div style="padding: 12px;">
       <img
        ...
        alt="VitalControl nustatymų meniu: 1 puslapis"
        usemap="#VitalControlSettingsPage1"
        style="max-width: 880px; width: 100%;"
        class="maphilight figure-img img-fluid" 
        align="bottom"
        title="VitalControl nustatymai (1)" />
    </div>
...
<figcaption class="figure-caption fs-6" style="margin-bottom: 1.5rem;">
    Ekrano nuotrauka 3: <span style="font-style: italic;">{{<T "VitalControl" >}}</span> nustatymų meniu, 1 puslapis
</figcaption>
...
<figure class="figure" style="margin-top: 5px; border: 2px solid #dee2e6; border-radius: 16px; overflow: hidden; margin-bottom: 0;">
    <div style="padding: 12px;">
       <img
        ...
        alt="Nustatymų meniu VitalControl: 2 puslapis"
        usemap="#VitalControlSettingsPage2"
        style="max-width: 880px; width: 100%;"
        class="maphilight figure-img img-fluid" 
        align="bottom"
        title="Nustatymai VitalControl (2)" />
    </div>
...
<figcaption class="figure-caption fs-6" style="margin-bottom: 1.5rem;">
    Ekrano nuotrauka 4: Nustatymų meniu <span style="font-style: italic;">{{<T "VitalControl" >}}</span>, 2 puslapis
</figcaption>
