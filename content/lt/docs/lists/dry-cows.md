...
6. Atsidarys kitas nustatymų meniu, kuriame galite išsaugoti įvairias naujo veršelio detales. Naudokite rodyklių klavišus △ ▽, kad pasirinktumėte tinkamą nustatymo parinktį. Nustatymo parinktims `{{<T "TypeAnimal" >}}`, `{{<T "Sex" >}}`, `{{<T "BirthWeight" >}}`, `{{<T "Breed" >}}`, `{{<T "Whereabouts" >}}`, `{{<T "Multiples" >}}` ir `{{<T "CalvingEase" >}}` naudokite rodyklių klavišus △ ▽, kad pasirinktumėte norimą nustatymą. Nustatymo parinktims `{{<T "NationalAnimalID" >}}`, `{{<T "_ID" >}}` ir `{{<T "DateBirth" >}}` pasirinkite atitinkamą nustatymo parinktį ir patvirtinkite su `{{<T "Ok" >}}`. Dabar naudokite rodyklių klavišus △ ▽ ◁ ▷, kad pasirinktumėte norimus skaitmenis.
