...
6. Відкриється інше меню налаштувань, у якому ви можете зберегти різні деталі про нове теля. Використовуйте клавіші зі стрілками △ ▽ для вибору відповідної опції налаштування. Для опцій налаштування `{{<T "TypeAnimal" >}}`, `{{<T "Sex" >}}`, `{{<T "BirthWeight" >}}`, `{{<T "Breed" >}}`, `{{<T "Whereabouts" >}}`, `{{<T "Multiples" >}}` та `{{<T "CalvingEase" >}}` використовуйте клавіші зі стрілками △ ▽ для вибору бажаного налаштування. Для опцій налаштування `{{<T "NationalAnimalID" >}}`, `{{<T "_ID" >}}` та `{{<T "DateBirth" >}}` виберіть відповідну опцію налаштування та підтвердіть за допомогою `{{<T "Ok" >}}`. Тепер використовуйте клавіші зі стрілками △ ▽ ◁ ▷ для вибору бажаних цифр.
