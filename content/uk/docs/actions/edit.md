...
6. Для даних `{{<T "_ID" >}}` і `{{<T "DateBirth" >}}` виберіть їх за допомогою клавіш зі стрілками △ ▽ і підтвердіть за допомогою `{{<T "Ok" >}}`. Використовуйте клавіші зі стрілками △ ▽, щоб вибрати відповідний номер, і клавіші зі стрілками ◁ ▷, щоб переміщатися в межах полів номера.
