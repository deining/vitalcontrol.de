...
6. Для налаштувань `{{<T "NationalAnimalID" >}}`, `{{<T "_ID" >}}` і `{{<T "DateBirth" >}}` використовуйте клавіші зі стрілками △ ▽, щоб вибрати потрібний варіант налаштування і підтвердьте натисканням `{{<T "Ok" >}}`. Використовуйте клавіші зі стрілками △ ▽◁ ▷, щоб вибрати потрібні цифри. Нарешті, підтвердьте натисканням `{{<T "Ok" >}}`.
