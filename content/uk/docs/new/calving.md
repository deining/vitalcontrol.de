...
6. Для налаштувань `{{<T "NationalAnimalID" >}}`, `{{<T "_ID" >}}` і `{{<T "DateBirth" >}}` використовуйте клавіші зі стрілками △ ▽, щоб вибрати бажаний варіант налаштувань і підтвердьте натисканням `{{<T "Ok" >}}`. Використовуйте клавіші зі стрілками △ ▽◁ ▷, щоб вибрати бажані цифри. Нарешті, підтвердьте натисканням `{{<T "Ok" >}}`.
