...
{{% alert title="Hint" %}}
Hvis denne handlingen ikke er tilgjengelig, har handlingen sannsynligvis blitt deaktivert! Aktiver handlingen i [handlingsinnstillingene](../settings/) menyen. Alternativt vil tilbakestilling av alle handlinger bringe handlingen tilbake.
{{% /alert %}}
