...
6. Pro nastavení `{{<T "NationalAnimalID" >}}`, `{{<T "_ID" >}}` a `{{<T "DateBirth" >}}` použijte šipky △ ▽ k výběru požadované možnosti nastavení a potvrďte `{{<T "Ok" >}}`. Pomocí šipek △ ▽◁ ▷ vyberte požadovaná čísla. Nakonec potvrďte `{{<T "Ok" >}}`.
