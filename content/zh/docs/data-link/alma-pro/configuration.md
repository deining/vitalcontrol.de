...
<figcaption class="figure-caption fs-6" style="margin-bottom: 1.5rem;">
    截圖 2：訪問 <span style="font-style: italic;">{{<T "VitalControl" >}}</span> 設定選單
</figcaption>
...
<figure class="figure" style="margin-top: 5px; border: 2px solid #dee2e6; border-radius: 16px; overflow: hidden; margin-bottom: 0;">
    <div style="padding: 12px;">
       <img
        ...
        alt="VitalControl 設定選單：第 1 頁"
        usemap="#VitalControlSettingsPage1"
        style="max-width: 880px; width: 100%;"
        class="maphilight figure-img img-fluid" 
        align="bottom"
        title="VitalControl 設定 (1)" />
    </div>
...
<figcaption class="figure-caption fs-6" style="margin-bottom: 1.5rem;">
    截圖 3：<span style="font-style: italic;">{{<T "VitalControl" >}}</span> 設定選單，第 1 頁
</figcaption>
...
<figure class="figure" style="margin-top: 5px; border: 2px solid #dee2e6; border-radius: 16px; overflow: hidden; margin-bottom: 0;">
    <div style="padding: 12px;">
       <img
        ...
        alt="設定菜單 VitalControl：第 2 頁"
        usemap="#VitalControlSettingsPage2"
        style="max-width: 880px; width: 100%;"
        class="maphilight figure-img img-fluid" 
        align="bottom"
        title="設定 VitalControl (2)" />
    </div>
...
<figcaption class="figure-caption fs-6" style="margin-bottom: 1.5rem;">
    截圖 4：設定菜單 <span style="font-style: italic;">{{<T "VitalControl" >}}</span>，第 2 頁
</figcaption>
