...
6. Dla danych `{{<T "_ID" >}}` i `{{<T "DateBirth" >}}` wybierz je za pomocą klawiszy strzałek △ ▽ i potwierdź `{{<T "Ok" >}}`. Użyj klawiszy strzałek △ ▽, aby wybrać odpowiednią liczbę i klawiszy strzałek ◁ ▷, aby nawigować w polach liczbowych.
